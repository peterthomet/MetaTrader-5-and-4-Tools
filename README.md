...
My major developments are the **[Trade Manager](/Trade%20Manager/Trade%20Manager.mq5)**, a **[Currency Strength indicator](/Currency%20Index/CurrencyStrength.mq5)** and a **[Pivot Points indicator](/Pivots/MultiPivots.mq5)**. A special facility allows very fast backtesting of currency strength related strategies. A SQLite database is used to build up a store of currency strength data. This database can then be used for backtesting with the Trade Manager without time consuming calculations.
